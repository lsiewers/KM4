<?php
    ...
    // if there has been any record
    if($row['totalOutBedAvg'] != NULL) {
        $calculatedCount = 0;
        ...
        // otherwise the chronotype's bed time is recommended at first
        $obj->inBedTimeRecommended = $row['chronoInBedTime'];
        $obj->outBedTimeRecommended = $row['chronoOutBedTime'];
    }
