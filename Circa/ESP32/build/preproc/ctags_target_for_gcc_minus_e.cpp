# 1 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ESP32.ino"
...
// Led strip libs
# 11 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ESP32.ino" 2
# 12 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ESP32.ino" 2
...
int STRANDCNT = ((sizeof(STRANDS) / sizeof(0 [STRANDS])) / ((size_t)(!(sizeof(STRANDS) % sizeof(0 [STRANDS])))));
...
# 45 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ESP32.ino" 2
# 46 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ESP32.ino" 2
...
// WiFi libs
# 58 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ESP32.ino" 2
# 59 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ESP32.ino" 2
...
// Json lib
# 68 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ESP32.ino" 2
...
//**************************************************************************//
# 1 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/fansFunctions.ino"
///*** fan settings ***///
// fan A
int enable1Pin = 27;
int fan1Pin1 = 26;
...
void fansInit()
{
  ...
  pinMode(fan1Pin1, 0x02);
  pinMode(fan1Pin2, 0x02);
  pinMode(enable1Pin, 0x02);
  // sets the pins as outputs:
  pinMode(fan2Pin1, 0x02);
  pinMode(fan2Pin2, 0x02);
  pinMode(enable2Pin, 0x02);
...
void fansOn()
{
  digitalWrite(enable1Pin, 0x0); // see page 7 of datasheet. You must keep ENABLE pin low before applying changes to IN
  digitalWrite(enable2Pin, 0x0);
  digitalWrite(fan1Pin1, 0x0);
  digitalWrite(fan1Pin2, 0x1);
  digitalWrite(fan2Pin1, 0x0);
  digitalWrite(fan2Pin2, 0x1);
}
...
void fansOff()
{
  ...
  digitalWrite(enable2Pin, 0x0);
  digitalWrite(fan1Pin1, 0x0);
  digitalWrite(fan1Pin2, 0x0);
  digitalWrite(fan2Pin1, 0x0);
  digitalWrite(fan2Pin2, 0x0);
}
...
# 1 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/httpRequests.ino"
...
void httpGetRecommended() {
    ...
    if (!err) {
      ...
      Serial.println(((reinterpret_cast<const __FlashStringHelper *>(("JSON incorrect?")))));
...
# 1 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ledFunctions.ino"
# 2 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ledFunctions.ino" 2
...
//   return color;
// }
# 1 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ledInit.ino"
...
void dumpSysInfo()
{
  ...
  Serial.print((int)sysinfo.features, 16);
  Serial.print("; Cores: ");
...
bool initStrands()
{
  ...
  {
    gpioSetup(STRANDS[i].gpioNum, 0x02, 0x0);
  }
  ...
  for (int i = 0; i < STRANDCNT; i++)
  {
    ...
    Serial.print(i);
    Serial.print(" = ");
    Serial.print((uint32_t)(pStrand->pixels), 16);
    Serial.println();
...
# 1 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/ntpClientInit.ino"
void ntpClientInit()
{
    timeClient.begin();
    timeClient.update();
...
# 1 "/Users/luuksiewers/Developer/PlatformIO/Projects/KM4/Circa/ESP32/recordTimes.ino"
